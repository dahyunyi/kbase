...
slices MD/${i:0:16}_MD_warped2MNI152_T1_1mm.nii.gz ${FSLDIR}/data/standard/MNI152_T1_1mm_brain.nii.gz -o ${i:0:16}_MDoverMNI152_T1.gif

slices FA/${i:0:16}_FA_warped2MNI152_T1_1mm.nii.gz ${FSLDIR}/data/standard/MNI152_T1_1mm_brain.nii.gz -o ${i:0:16}_FAoverMNI152_T1.gif
